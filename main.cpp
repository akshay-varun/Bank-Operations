...
{
	cout<<account_no_<<setw(10)<<" "<<name_<<setw(10)<<" "<<type<<setw(6)<<balance_<<endl;
}
...
void Transaction::trans_compute()
{
	...
	while(inFile.read((char *)&  b, sizeof(Bank)))
	{
		...
		if(acc_no!=0)
		{
		cout<<"\nThe interest for the account number "<<num<<" for previous month (3%  interest ) is :"<<b.ret_balance()*0.03<<endl;
		}
